...
def parse_arguments() -> None:
    ...
    parser.add_argument(
        ...
        help="Dangerous: Allows Auto-GPT/Auto-Claude to download files natively.",
    )
    ...
    if args.allow_downloads:
        ...
        logger.typewriter_log(
            "WARNING: ",
            Fore.YELLOW,
            f"{Back.LIGHTYELLOW_EX}Auto-GPT/Auto-Claude will now be able to download and save files to your machine.{Back.RESET} "
